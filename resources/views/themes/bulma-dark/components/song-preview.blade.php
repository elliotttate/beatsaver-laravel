    ...
    <div class="columns is-mobile">
        ...
        <div class="column">
            <table class="table is-fullwidth">
                ...
                <tr>
                    <td colspan="2">
                        <a class="button is-light" href="{{ $downloadUrl }}" role="button">Download File</a>
                        <a class="button is-light" href="https://bsaber.com/songs/{{ $id }}" role="button">View on BeastSaber</a>
                        <button class="button is-light for-playing" onclick="previewSong(this, '{{ $downloadUrl }}')" role="button">Preview</button>
                    </td>
                </tr>
            </table>
        </div>
