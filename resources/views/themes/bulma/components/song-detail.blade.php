    ...
    <div class="columns is-mobile">
        <div class="column" style="max-width: 200px;">
            ...
            <button
                ...
                onclick="previewSong(this, '/storage/songs/{{ $id }}/{{ $key }}.zip')"
                role="button"
                        ...
                        @auth
                            <div>
                                <form action="{{ route('votes.submit',['key' => $key]) }}" method="post">
                                    {{ csrf_field() }}
                                    <button type="submit" class="button" name="type" value="up">
                                        <span class="icon"><i class="fas fa-thumbs-up"></i></span>
                                        <span>Up {{ $upVotes }}</span>
                                    </button>
                                    <button type="submit" class="button" name="type" value="down">
