            ...
            <form class="form-signin" method="post" enctype="multipart/form-data" action="{{ route('upload.submit') }}">
                ...
                <div class="form-group">
                    ...
                    <ul>
                        ...
                        <li>You will not be able to edit your song after uploading, only delete. This is due to how scoreboards work. Stick to uploading completed and tested songs to the benefit of
                            your
                            fans.
                        </li>
                        ...
                        <li>Do not plagiarise or attempt to steal the work of others. Do not also upload or use other people's work without their explicit permission (including, but not limited to,
                            skins
